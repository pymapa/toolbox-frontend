...
export const getAccessTokenWithCode = async (authorizationCode: string): Promise<StravaUser> => {
...
export const refreshAccessToken = async (refreshToken: string): Promise<StravaUser> => {
  const body = JSON.stringify({
    client_id: PUBLIC_STRAVA_CLIENT_ID,
    client_secret: STRAVA_CLIENT_SECRET,
